...
export function ProjectSchema1({image, title, description, github_url, proj_url}){
	return <div className="w-11/12 m-7 p-12 flex flex-row relative justify-center">
		<div className="w-8/12 max-w-xl group absolute md:left-24">
		...
		<div className="absolute md:right-24 w-8/12">
			<p className="text-right md:text-2xl text-lg font-serif font-semibold text-gray-300 m-2 p-2 mt-0">{title}</p>
