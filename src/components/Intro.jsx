	...
	return <div className="relative">
		<div className="ml-[10%] p-8 font-serif space-y-4 mt-36">
           ...
           bg-clip-text text-transparent"
			>Hi, My name is</p>
			<p className="z-10 animate-slide-down delay-100 md:text-6xl font-semibold text-7xl bg-gradient-to-l from-red-500 via-orange-400 to-amber-400 bg-clip-text text-transparent"
			>
				Harsh Goel
			</p>
			<div className="z-10 flex flex-row">
				<p className="text-gray-300 animate-slide-down md:text-5xl delay-300 font-semibold text-6xl">
			...
			<div className="animate-fade-in delay-300 text-gray-300 z-10 pt-6 lg:w-7/12 w-8/12 leading-7">
